...
This repository is a **Codex plugin marketplace** containing the `ppt-icon-studio` plugin.
...
After updating the GitHub repository later, refresh the marketplace snapshot and reinstall:
...
This repository follows the standard Codex plugin layout:
